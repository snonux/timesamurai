...
type sessionAction func(ctx context.Context, store *worktime.Store, cfg config.AccountingConfig, host string, tags []string, at time.Time, descr string) (worktime.Entry, error)
